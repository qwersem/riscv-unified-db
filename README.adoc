...
* https://gitsnps.internal.synopsys.com/dwarc/rnd/hardware/rvv/rvv_udb/-/jobs/artifacts/main/raw/gen/prm_pdf/prm_demo_rv32_with_external/pdf/prm_demo_rv32_with_external-specification.pdf?job=pdf[The latest UDB-generated Programmer's Reference Manual (PRM) PDF `Internal`]
